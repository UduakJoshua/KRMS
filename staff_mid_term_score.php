...
<main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h6">Student's Mid-Term Score Input</h1>
                                    ...
                                    <div class="score ">
                                        <div class="row mt-1 ml-auto mr-2">
                                            ...
                                            <div class="col-md-2">
                                                ...
                                                <div class="form-group">
                                                    <input type="number" name="T2[]" placeholder="Enter T2 " class="form-control" max="20">
                        ...
                        <div class=" card-footer">
                            <div class="row">
                                <div class=" col-md-2 form-group">
                                    <button class="btn btn-primary" name="save_mid">Save MT Scores</button>
                                </div>
