...
<main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
    ...
    <section>
        <div class=" container-fluid  justify-content-center">
            ...
            $select_sql = "SELECT * FROM e_videos ";
                    ...
                    <tbody class="ml-2">
                        ...
                        while ($row = $sql_result->fetch_assoc()) : ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="e_videos.php?edit=<?php echo $row['id']; ?>" class=" btn btn-info btn-sm"> Edit</a>
                                    <a href="./controller/e_videos_logic.php?delete=<?php echo $row['id']; ?>" class=" btn btn-danger btn-sm">Delete</i></a>
                                </td>
                            </tr>
