                    ...
                    while ($row = mysqli_fetch_assoc($result)) : ?>
                        <ul class="nav flex-column">
                            ...
                            <li class="nav-item">
                                <?php if ($row['class_name'] == "JSS Three" || $row['class_name'] == "SSS Three") :
                                ?>
                                    <a class="nav-link d-none" href="select_term.php">
                                        <span data-feather="file"></span>
                                        Midterm Result
                                    </a>
                                <?php else :  ?>
                            ...
                            <li class="nav-item">
                                ...
                                <?php elseif ($row['class_name'] == "JSS Three" || $row['class_name'] == "SSS Three") :
                                ?>
                                    <a class="nav-link d-none" href="student_result_display.php">
                                        <span data-feather="file"></span>
