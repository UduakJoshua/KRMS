                                        ...
                                        <tbody class="ml-1 pt-2" style="font-size: 20px;">
                                            ...
                                            <?php while ($row = mysqli_fetch_assoc($result)) :
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="midterm_edit.php?edit_mt_score=<?php echo $row['id']; ?>" class=" btn btn-info btn-sm"> Edit</a>
                                                        <a href="./controller/score_upload_logic.php?delete_mt_score=<?php echo $row['id']; ?>" class=" btn btn-danger btn-sm"><i>Delete</i></a>
                                                    </td>
                                                </tr>
                                            <?php endwhile ?>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card-footer">
                                    <a href="result_management.php"><button type="button" class="btn btn-primary mr-4">Back</button></a>
                                    <a href="mid_term_score_init.php"><button type="button" class="btn btn-primary ml-4">Input Another Score</button></a>
                                </div>
                            </div>
                        </div>
                    <?php else : ?>
                        <div class="col-md-12 bg-warning text-center mt-4 pt-4">
                            ...
                            <a href="mid_term_score_init.php"><button type="button" class="btn btn-primary m-4">Input Score</button></a>
                        </div>
                    <?php endif ?>
                    </div>
