                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card-footer">
                                    <a href="scores_input_view_teacher.php"><button type="button" class="btn btn-primary mr-4">Back</button></a>
                                    <a href="teacher_exam_init.php"><button type="button" class="btn btn-primary ml-4">Input Another Score</button></a>
                                </div>
