                ...
                if (mysqli_num_rows($result) > 0) : ?>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card-footer">
                                    <a href="mock_view_teacher.php"><button type="button" class="btn btn-primary mr-4">Back</button></a>
                                    <a href="mock_input_teacher.php"><button type="button" class="btn btn-primary ml-4">Input Another Score</button></a>
                                </div>
                    ...
                    <?php else : ?>
                        <div class="col-md-12 bg-warning text-center mt-4 pt-4">
                            ...
                            <a href="mock_input_teacher.php"><button type="button" class="btn btn-primary m-4">Input Score</button></a>
                        </div>
                    <?php endif ?>
                    <?php $conn->close(); ?>
