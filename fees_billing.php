                                            ...
                                            <tbody class="ml-1 pt-2" style="font-size: 10px;">
                                                ...
                                                while ($row = mysqli_fetch_assoc($result)) : ?>
                                                    <tr>
                                                        ...
                                                        <td><input type="number" name="school_fees" value=0 class="form-control" size="50"></td>
                                                        <td><input type="number" name="discount" value=0 class="form-control"></td>
                                                        <td><input type="number" name="arrears" value=0 class="form-control" size="50"></td>
                                                        <td><input type="number" name="bus" value=0 class="form-control"></td>
                                                        <td><input type="number" name="books" value=0 class="form-control"></td>
                                                        <td><input type="number" name="total_discount" class="form-control"></td>
                                                        ...
                                                        <td><button type="button" class="btn btn-primary" name="bill_student">Bill</button></td>
                                                    </tr>
                                                <?php endwhile; ?>
                                            </tbody>
                                        </table>
