    ...
    <section>
        <section>
            ...
            <div class="row justify-content-center">
                <div class="col-md-12">
                    <form action="mock_admin_init_dis.php" method="POST">
                        <div class="card">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="card-footer">
                                        <button type="submit" class="btn btn-primary" name="mock_disp_initialize">Initialize</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <tbody class="ml-1 pt-2" style="font-size: 10px;">
                                            ...
                                            while ($row = mysqli_fetch_assoc($result)) : ?>
                                                <tr>
                                                    ...
                                                    <td><input type="text" name="mock_no" value="<?php echo $mock_no ?>" readonly class="form-control" size="30"></td>
                                                    <td><a href="mock_result_display_admin.php?displayMT=<?php echo $row['admissionNo']; ?>"><button type="button" class="btn btn-primary" name="display_MT">Display</button></a></td>
                                                </tr>
                                            <?php endwhile; ?>
                                        </tbody>
                                    </table>
