                ...
                <div class="row mt-3">
                    <div class="col-md-8">
                        <div>
                            ...
                            $select_sql = "SELECT COUNT(subject) AS no_subjects, SUM(T1+T2+ exam) AS overall,  (SELECT no_of_subjects FROM no_of_subjects WHERE class_name = '$student_class') subject_total , student_name   FROM students_score WHERE admission_no='$ad_no' && term= '$term' && session = '$academic_session'";
                            $sql_result = $conn->query($select_sql);
