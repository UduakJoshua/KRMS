            ...
            <div class="col-md-12">
                <div class="card ">
                    <div class="card-header">
                        <h6>Modify Student's Mid-Term Scores</h6>
                    </div>
                    <form action="midterm_edit.php" method="POST">
                            ...
                            <div class="row mt-1 ml-auto mr-2">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group ">
                                        ...
                                        <input type=" text" name="student_name" class="form-control" readonly value="<?php echo $name ?>">
                                    </div>
                                </div>
                        ...
                        <div class=" card-footer">
                            <div class="row">
                                <div class=" col-md-2 form-group">
                                    <button class="btn btn-primary" name="update_midterm">Update</button>
                                </div>
