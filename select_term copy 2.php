...
<main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
  ...
  <section>
    ...
    <div class="bg-info p-2 text-white">
      <h6><strong>How to Check Mid Term Result!</strong></h6>

      <ul>
        <li>Select the current Term</li>
        <li>Select the current Academic Session</li>
        <li>Click the Display Result </li>
        <li>Scroll down and hit the download button to download</li>
      </ul>
    </div>
    <hr>
    <?php
    ...
    <div class="row justify-content-center">
      <div class="col-md-12">
        <form action="select_term.php" method="POST">
              ...
              <div class="row">
                <div class="col-md-4">
                  ...
                  <?php if ($section == "Basic" && $approval == 1) : ?>
                    <button class="btn btn-danger btn-block mt-2" name="midTermBasic">Display Result</button>

                  <?php elseif ($section == "Nursery" && $approval == 1) : ?>
                    <button class="btn btn-primary btn-block mt-2" name="midTermNur">Display Result</button>

                  <?php elseif ($section == "High" && $approval == 1) : ?>
                    <button class="btn btn-dark btn-block mt-2" name="midTermHigh">Display Result</button>
                  <?php else : ?>
                    <!-- php code for result that is not ready or approved-->
                    <a class="nav-link" href="exam_notification.php" class="text-decoration-none"><button class="btn btn-danger btn-block mt-4">1st Term</button></a>
                  <?php endif; ?>
