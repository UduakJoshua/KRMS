                                        ...
                                        <tbody class="ml-1 pt-2" style="font-size: 10px;">
                                            ...
                                            while ($row = mysqli_fetch_assoc($result)) : ?>
                                                <tr>
                                                    ...
                                                    <td><input type="text" name="student_class" value="<?php echo $row['class_name'] . " " . $row['classArm'] ?>" readonly class="form-control" size="40"></td>
                                                    <td><input type="text" name="subject" value="<?php echo $subject ?>" readonly class="form-control" size="30"></td>
                                                    <td><input type="number" name="T1[]" class="input-sm form-control" placeholder="T1" value="" maxlength="4" max="20"></td>
                                                    <td><input type="number" name="T2[]" class="input-sm form-control" placeholder="T2" value="" maxlength="4" max="20"></td>
                                                    <td><input type="number" name="project[]" class="input-sm form-control" placeholder="Proj" value="" maxlength="4" max="10"></td>
                                                    <td><input type="number" name="assign[]" class="input-sm form-control" placeholder="Ass" value="" maxlength="4" max="20"></td>
                                                    <td><input type="number" name="exam[]" class="input-sm form-control" placeholder="Exam" value="" maxlength="4" max="60"></td>
