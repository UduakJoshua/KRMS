...
<main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h4">View Uploaded Mid-Term Scores</h1>
    ...
    <section>
        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                <form action="midterm_scores_teacher_init.php" method="POST">
                    <div class="card">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card-footer">
                                    <button type="submit" class="btn btn-primary" name="mt_score_view_t">Display Scores</button>
                                </div>
                            </div>
                        </div>
                    </div>
